...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@200;300;400;500;600;700&family=Viga&display=swap" rel="stylesheet">
</head>
        ...
        <div class="row">
          <div class="col-md-5">
            <div class="banner_content">
              <h1><span>Rental Mobil Murah</span> Untuk Setiap Kebutuhan</h1>
              <p>Dapatkan tarif sewa mobil terbaik dengan sopir maupun lepas kunci hanya di Mocar.</p>
            </div>
          </div>
        </div>
      </div>
