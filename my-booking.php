...
?>
  ...
  <head>
    ...
    <title>MoRental | List Booking</title>
    <!--Bootstrap -->
              ...
              <div class="col-md-3 col-sm-3">
                ...
                <div class="col-md-6 col-sm-8">
                  <div class="profile_wrap">
                    <h5 class="uppercase underline">List Bookings </h5>
                ...
                <div class=" vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">Dikonfirmasi</a>
